...
function decodeUplink(input) {
    ...
    if (decoded["batch"] !== undefined) {
        ...
        let decoded = batch.brUncompress(3, [{taglbl: 0,resol: 10, sampletype: 7,lblname: "temperature", divide: 100}, { taglbl: 5, resol: 100, sampletype: 6, lblname: "BatteryVoltage", divide: 1000}] ,bytes, input.date);
