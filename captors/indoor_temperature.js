...
function decodeUplink(input) {
    ...
    if (decoded["batch"] !== undefined) {
        ...
        let decoded = batch.brUncompress(2, [{taglbl: 0,resol: 10, sampletype: 7,lblname: "Temperature", divide: 100},{ taglbl: 2, resol: 1, sampletype: 6,lblname: "BatteryVoltage", divide: 1000}] ,bytes, input.date);
