...
function Bytes2Float32(bytes) {
    ...
    console.log(significand);console.log(exponent);
...
function Decoder(bytes, port) {
    ...
    if (port === 125){
        ...
        if (decodedBatch === false){
            ...
            var decoded = {};
            brData = (brUncompress(3,[{taglbl: 0,resol: 0.004, sampletype: 12,lblname: "4_20mA", divide: 1},{ taglbl: 1, resol: 1, sampletype: 12,lblname: "0_10V", divide: 1}, { taglbl: 2, resol: 100, sampletype: 6,lblname: "BatteryVoltage", divide: 1000}, { taglbl: 3, resol: 100, sampletype: 6,lblname: "ExternalPowerVoltage", divide: 1000},{ taglbl: 4, resol: 1, sampletype: 10,lblname: "Index", divide: 1}], lora.payload, lDate))
...
const ignore_vars = ['timestamp','lora_bandwidth','lora_spreading_factor','data_rate_index','coding_rate','frequency','time','gateway_eui'];
//timestamp,fport,fcnt,payload,rssi,snr, application_id , downlink_key, device_id
